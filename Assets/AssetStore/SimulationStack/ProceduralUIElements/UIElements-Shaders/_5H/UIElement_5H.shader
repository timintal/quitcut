Shader "ProceduralUIElements/UIElement_5H" 
{
    Properties
    {
        ...
        _Thickness("Thickness", Range(0.0, 1.0)) = 0.12
        _EdgeAngle("Edge Angle", Range(0.0, 0.3)) = 0.035
        ...
        //
        _EdgeBlur("Edge Blur", Range(0.0, 0.1)) = 0.06
    ...
    CustomEditor "ProceduralUIElements.ShaderGUI_UIElement_5H"
}
