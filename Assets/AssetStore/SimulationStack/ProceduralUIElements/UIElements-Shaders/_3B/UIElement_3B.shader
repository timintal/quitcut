Shader "ProceduralUIElements/UIElement_3B"
{
    Properties
    {
        ...
        _EdgeAngle("Edge Angle", Range(1.2, 8.5)) = 3.0
        //
        _CornerRoundness("Roundness", Range(0.0, 0.5)) = 0.01
        //
    ...
    CustomEditor "ProceduralUIElements.ShaderGUI_UIElement_3B"
}
