Shader "ProceduralUIElements/UIElement_3E"
{
    Properties
    {
        ...
        _MoveSpeed("Animation Speed", Float) = 1.0
        [IntRange]_Frequency("Frequency/Delay", Range(1.0, 10.0)) = 2.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _MaskColor;
            float _RectMaskSizeX;
            float _RectMaskSizeY;
            float _RectMaskRoundness;
            float _RectMaskBlur;
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float MaskSDF = StarSDF(UV, _Size, _Turns, _EdgeAngle) - _CornerRoundness;
   ...
   CustomEditor "ProceduralUIElements.ShaderGUI_UIElement_3E"
}
