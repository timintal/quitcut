Shader "ProceduralUIElements/UIElement_9H" 
{
    Properties
    {
        ...
        [Space(20)]
        [KeywordEnum(Circle, Rectangle, Polygon, Heart)] _MaskContainer("Choose Shape", Float) = 0
        //
        ...
        //
        _EdgeBlur("Edge Blur", Range(0.0, 0.03)) = 0.01
    ...
    CustomEditor "ProceduralUIElements.ShaderGUI_UIElement_9H"
}
