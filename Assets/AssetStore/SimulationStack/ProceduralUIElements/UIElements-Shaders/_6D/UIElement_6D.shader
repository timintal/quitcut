Shader "ProceduralUIElements/UIElement_6D"
{
    Properties
    {
        [Space(15)]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float DisplaceShapeSDF = HeartSDF_Custom(UV * (12 - _Size) - float2(_ShapeOffsetX, _ShapeOffsetY));
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float ShadowSDF = HeartSDF_Custom(ShadowUV * (12 - _Size));
                if(_EnableRim==1)
                {
                    SDF = abs(SDF) - _RimWidth;
    ...
    CustomEditor "ProceduralUIElements.ShaderGUI_UIElement_6D"
}
