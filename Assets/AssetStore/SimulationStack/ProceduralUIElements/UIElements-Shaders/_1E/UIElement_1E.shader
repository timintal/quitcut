Shader "ProceduralUIElements/UIElement_1E"
{
    Properties
    {
        ...
        _RimWidth("Rim Width", Range(0.0, 0.5)) = 0.02
        //
        _EdgeBlur("Edge Blur", Range(0.0, 0.2)) = 0.025
        ...
        [Space(20)]
        [Toggle(EnableMaskColor)] _EnableMaskColor("Enable Mask Color", float) = 0
    ...
    CustomEditor "ProceduralUIElements.ShaderGUI_UIElement_1E"
}
