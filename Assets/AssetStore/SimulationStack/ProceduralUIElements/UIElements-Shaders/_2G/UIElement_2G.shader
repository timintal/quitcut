Shader "ProceduralUIElements/UIElement_2G"
{
    Properties
    {
        [Space(20)]
        ...
        [Space(20)]
        [Toggle(EnableDropShadow)] _EnableDropShadow("Enable Drop Shadow A", float) = 0
        ...
        [Space(20)]
        [Toggle(EnableShadow)] _EnableDropShadowB("Enable Drop Shadow B", float) = 0
        _DropShadowBSize("Size", Range(-0.2, 0.2)) = 0.0
        _DropShadowBSpread("Spread", Range(0.0, 1.0)) = 0.35
        _DropShadowBGamma("Gamma", Range(0.0, 6.0)) = 1.0
        _DropShadowBXOffset("Offset X", Range(-0.1, 0.1)) = 0.0
        _DropShadowBYOffset("Offset Y", Range(-0.1, 0.1)) = 0.0
        _DropShadowBOpacity("Opacity", Range(0.0, 2.0)) = 1.0
        [KeywordEnum(Color, Gradient)] _DropShadowBColorMode("Color Mode", Float) = 0
        [KeywordEnum(2 Color, 3 Color, 4 Color)] _DropShadowBGradientMode("Gradient Mode", Float) = 0
        _DropShadowBColor("Shadow Color", Color) = (0.45, 0.45, 0.45, 1)
        _ColorBE("Gradient Color A", Color) = (0.45, 0.45, 0.45, 1.0)
        _ColorBF("Gradient Color B", Color) = (0.45, 0.45, 0.45, 1.0)
        _ColorBG("Gradient Color C", Color) = (0.45, 0.45, 0.45, 1.0)
        _ColorBH("Gradient Color D", Color) = (0.45, 0.45, 0.45, 1.0)
        _DropShadowBGradientAngle("Gradient Angle", Range(0, 360)) = 0
        _DropShadowBGradientScale("Gradient Scale", Range(0.0, 2.0)) = 0.5
    ...
    CustomEditor "ProceduralUIElements.ShaderGUI_UIElement_2G"
}
