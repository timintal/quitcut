Shader "ProceduralUIElements/UIElement_6C"
{
    Properties
    {
        [Space(20)]
        ...
        //
        _EdgeBlur("Edge Blur", Range(0.0, 1.0)) = 0.5
    ...
    CustomEditor "ProceduralUIElements.ShaderGUI_UIElement_6C"
}