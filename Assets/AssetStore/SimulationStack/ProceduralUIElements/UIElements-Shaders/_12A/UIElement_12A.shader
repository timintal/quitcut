Shader "ProceduralUIElements/UIElement_12A"
{
    Properties
    {
        [Space(20)]
        ...
        //
        [KeywordEnum(Symetrical, Set Each Corner)] _ChooseRoundnessMode("Choose Roundness Mode", Float) = 0
        ...
        //
        _EdgeBlur("Edge Blur", Range(0.001,0.05)) = 0.001
        //
        [Toggle(EnableBG)] _EnableContainerColor("Container Color", float) = 0
        _ContainerColor("Color", Color) = (0.45, 0.45, 0.45, 1.0)
        ...
        [Space(20)]
        [IntRange]_NoOfCells("Number Of Cells", Range(0.0,20.0)) = 5.0
        _CellOffset("X Offset", Range(0.0, 1.0)) = 0.0
        _CellWidth("Width", Range(0.0, 1.0)) = 0.1
        _CellHeight("Height", Range(0.0, 1.0)) = 0.1
        _CellCornerRoundness("Corner Roundness", Range(0.0, 0.5)) = 0.015
        _CellEdgeBlur("Edge Blur", Range(0.0, 1.0)) = 0.1
        _RotateCell("Rotate", Range(0.0, 360.0)) = 0.0


        [Space(20)]
        _CellsFillAmount("Fill Amount", Range(0.0,1.0)) = 1.0
        [Toggle(EnableDisableCell)] _EnableDisableCell("Disable Cell", float) = 0
        _DisableCellColor("Disable Cell Color", Color) = (0.45, 0.45 ,0.45, 1)
        ...
        [Space(20)]
        [Toggle(ColorModeToEachCell)] _ApplyColorModeToEachCell("Apply Color Mode To Cell", float) = 0
    ...
    CustomEditor "ProceduralUIElements.ShaderGUI_UIElement_12A"
}
