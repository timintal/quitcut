Shader "ProceduralUIElements/UIElement_8H" 
{
    Properties
    {
        ...
        _CornerRoundnessA("Corner Roundness", Range(0.0, 0.5)) = 0.0
        ...
        _CornerRoundnessB("Corner Roundness", Range(0.0, 0.5)) = 0.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float ShadowSDF = 0;
                ShadowSDF = CalculateSDF(ShadowUV);
                if(_EnableRim == 1)
                {
    ...
    CustomEditor "ProceduralUIElements.ShaderGUI_UIElement_8H"
}
