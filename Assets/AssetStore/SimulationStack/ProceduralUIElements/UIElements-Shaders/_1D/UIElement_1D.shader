Shader "ProceduralUIElements/UiElement_1D"
{
    Properties
    {
        [Space(20)]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "../CodeBlock/Variables_DisplaceShape.cginc"
            float _RadialGradientMode;
            float _RadialOffset;
            float _EnableColor;
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                col = DisplaceShape(UV, SelectedColor);
    ...
    CustomEditor "ProceduralUIElements.ShaderGUI_UIElement_1D"
}
