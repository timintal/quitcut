namespace SRDebugger.UI.Tabs
{
    ...
    public class OptionsTabController : SRMonoBehaviourEx
    {
        private class CategoryInstance
        {
            ...
            public void AddControl(OptionsControlBase control)
            {
                Options.Add(control);
                CategoryGroup.childControls.Add(control.gameObject);
            }
        }
        ...
        protected void CreateCategory(string title, List<OptionDefinition> options)
        {
            ...
            foreach (var option in options)
            {
                ...
                categoryInstance.AddControl(control);
            ...
            categoryInstance.CategoryGroup.SetControlsState(false);
        }
