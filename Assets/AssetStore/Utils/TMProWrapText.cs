...
public class TMProWarpText : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if (!myRectTransform) myRectTransform = gameObject.GetComponent<RectTransform>();
    ...
    private void WarpText()
    {
        ...
        float boundsMinX = myRectTransform.rect.min.x;//text.bounds.min.x;
        float boundsMaxX = myRectTransform.rect.max.x;//text.bounds.max.x;
