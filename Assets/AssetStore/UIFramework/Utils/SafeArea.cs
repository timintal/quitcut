...
namespace Magero.UIFramework.Utils
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        [SerializeField, Range(0f,1f)] private float ConformPercent = 1;// Conform to screen safe area on Y-axis (default true, disable to ignore)
        ...
        void ApplySafeArea (Rect r)
        {
            ...
            if (Screen.width > 0 && Screen.height > 0)
            {
                ...
                anchorMin.x *= ConformPercent;
                anchorMax.x = 1 - (1 - anchorMax.x) * ConformPercent;
                //
                anchorMin.y *= ConformPercent;
                anchorMax.y = 1 - (1 - anchorMax.y) * ConformPercent;
