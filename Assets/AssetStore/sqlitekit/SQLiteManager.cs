...
public class SQLiteManager : MonoBehaviour
{
	...
	/*
	 *   the excuse for initialized variable because follow error happened on if(instance == false) at non main thread
	 * 
	...
	void OnDestroy()
	{
        // make sure all database closed.
        foreach (SQLiteAsync db in dbs.Values)
		{
			db.Close(null, null);
		}
	}
